...
class PretragaNumberInput extends ElementPretrage{
    ...
    private function SetupType($type){
        switch ($type) {
            case 1:
                $this->naziv = "Broj članova";
                //TODO - Dohvatiti iz baze
                $this->DodajMogucuVrijednost("Broj članova");
                ...
                $this->odabranaVrijednost = "Broj članova";
    ...
    function DohvatiView(){
        ...
        $view = $view. "<input type='number' class='ml-1 valuePretrage' style='width:40% !important; min-width:75px; height:26px;' onchange='setTypePretrage(\"".$this->ID."\",\"ml-1 valuePretrage\")'
